...
void compute_stats() {
    ...
    double total_time = MEMORY_READ_TIME * stats.accesses + DISK_PAGE_READ_TIME * stats.page_faults + DISK_PAGE_WRITE_TIME * stats.writebacks;
    stats.aat = total_time / stats.accesses;
}
